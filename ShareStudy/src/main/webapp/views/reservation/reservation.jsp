			    ...
			    <div>	    
				    ...
				    <div id="divBor"> 
						...
						<div align="right" id="check">
							<input type="checkbox" name="" id="" > <label>전체동의</label>
						</div>
						<br>
						<input type="checkbox" name="" id="" > <label>위 공간의 예약 조건 확인 및 결제 진행 동의</label> <br>
						<input type="checkbox" name="" id="" > <label>환불 규정 안내에 대한 동의</label> <br>
						<input type="checkbox" name="" id="" > <label>개인정보 제3자 제공 동의</label> <br>
						<input type="checkbox" name="" id="" > <label>개인정보 수집 및 이용 동의</label> <br>
				    </div>				    
			    </div>
			   
			   <br><br>
			    <button class="btn btn-block" style="background-color: #a3c296; font-weight: bold;">결제하기</button>
	    </form>
